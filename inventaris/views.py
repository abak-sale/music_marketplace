...
def dashboard(request):
    ...
    # Tambahan perhitungan Total Modal Terjual (Omset - Laba) untuk Dashboard
    total_modal_terjual = omset_bulan_ini - laba_bulan_ini
...
def laporan_bulanan(request):
    ...
    # Hitung Total Modal Terjual (HPP) = Omset - Laba bulan tersebut
    total_modal_terjual = total_omset - total_laba
